...
class ChildListAdapter(private val mContext: Context, private var mList: List<ChildContract>, private val vModel: MainVModel) : RecyclerView.Adapter<ChildListAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(viewGroup: ViewGroup, i: Int): ViewHolder {
        val bi: ItemMemListBinding = DataBindingUtil.inflate(LayoutInflater.from(mContext), R.layout.item_mem_list, viewGroup, false)
...
/*        holder.bi.genderImage.setImageResource(getMemberIcon(mList[i].gender.toInt(), mList[i].age))
    ...
    class ViewHolder(val bi: ItemMemListBinding) : RecyclerView.ViewHolder(bi.root)
