                ...
                if (DownloadManager.ACTION_DOWNLOAD_COMPLETE.equals(intent.getAction())) {
                    ...
                    if (cursor.moveToFirst()) {
                        ...
                        if (DownloadManager.STATUS_SUCCESSFUL == cursor.getInt(colIndex)) {
                            ...
                            bi.appbarmain.contentmain.lblAppVersion.setText("TPVICS_HH App New Version " + newVer + "  Downloaded.");
        ...
        if (versionAppContract != null) {
            ...
            if (versionAppContract.getVersioncode() != null) {
                ...
                if (MainApp.versionCode < Integer.valueOf(versionAppContract.getVersioncode())) {
                    ...
                    if (file.exists()) {
                        bi.appbarmain.contentmain.lblAppVersion.setText("TPVICS-HH New Version " + newVer + "  Downloaded.");
                        showDialog(newVer, preVer);
                    } else {
                        NetworkInfo networkInfo = ((ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
                        if (networkInfo != null && networkInfo.isConnected()) {

                            bi.appbarmain.contentmain.lblAppVersion.setText("TPVICS-HH App New Version " + newVer + " Downloading..");
                            downloadManager = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
                            ...
                            request.setDestinationInExternalPublicDir(fileName, versionAppContract.getPathname())
                                    ...
                                    .setTitle("Downloading TPVICS-HH App new App ver." + newVer);
                            ...
                            bi.appbarmain.contentmain.lblAppVersion.setText("TPVICS-HH App New Version " + newVer + "  Available..\n(Can't download.. Internet connectivity issue!!)");
                        }
                    }
    ...
    public static class MyDialogFragment extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            return new AlertDialog.Builder(getActivity())
                    ...
                    .setMessage("TPVICS-HH App " + newVer + " is now available. You are currently using older version " + preVer + ".\nInstall new version to use this app.")
